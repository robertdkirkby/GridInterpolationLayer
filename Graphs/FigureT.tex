...
\tikzset{
  ...
  bigRinf/.style={circle, draw=darkyellow, fill=black, text=white,
                  minimum size=8.8mm, font=\footnotesize\bfseries,
                  line width=0.4mm, inner sep=0pt},
...
\begin{tikzpicture}[yscale=4]
  ...
  \node[smallcell] (Ropt) at (0,   2 + 4/6) {$R_{2.4}$};
  \node[pluslabel]        at (0.75, 2 + 4/6) {$+$};
  \node[smallcell] (Vopt) at (1.5, 2 + 4/6) {$V_{2.4}$};
