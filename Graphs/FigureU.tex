...
\tikzset{
  ...
  bigVinf/.style={circle, draw=darkyellow, fill=black, text=white,
                  minimum size=8.8mm, font=\footnotesize\bfseries,
                  line width=0.4mm, inner sep=0pt},
  ...
  smallVinf/.style={circle, draw=darkorange, fill=black, text=white,
                    minimum size=6mm, font=\tiny\bfseries,
                    line width=0.3mm, inner sep=0pt},
...
\begin{tikzpicture}[yscale=4]
  ...
  \foreach \k in {1,...,5} {
    ...
    \node[smallVinf] (Vs3\k) at (1.5, 3 + \k/6) {$V_{3.\k}$};
  }
